...
def previousStates(gameState, tree): #fix
    # Rezultātu masīvs
    theoretical_arr = []
    # Pirmā spēlētāja punktu skaits
    player1_points = (gameState//10**5)%1000
    # Atlikušo akmentiņu skaits
    points_toGrab = (gameState//10**3)%100
    # Otrā spēlētāja punktu skaits
    player2_points = gameState%1000
    player = gameState//10**8
    # Ja ir pirmā spēlētāja kārta
    if player == 1:
